...
export default function Home() {
  return (
    <>
          ...
          <FadeIn transitionDuration={1000}>
            <Box mb={30}>
              ...
              <Text c="white" fz="2rem" lh={1.2} fw={500} mb={25}>
                <strong>Marketing Ops na prática</strong>: Todo o conhecimento que você precisa para organizar os dados
                da sua empresa, sair do operacional e gerar mais resultados!
              </Text>
              <Text c="white" fz="1.2rem" fw={500} opacity={0.85}>
                O processo de estruturação de dados de Marketing Ops é um grande desafio para as empresas, desde coletar
                os dados corretamente, garantir a confiabilidade das métricas e também identificar e otimizar os
                resultados dos diferentes canais de aquisição.
              </Text>
            </Box>
            <Button
              size="xl"
      ...
      <Flex className={styles.section} bg="var(--mantine-color-gray-9)" align="center" direction="column">
        <Flex maw={650} mb={50} align="center" ta="center">
          <FadeIn transitionDuration={1000}>
            ...
            <Text c="white" fz="1.1rem" lh={1.4} fw={600} opacity={0.8}>
              O curso Marketing Ops na Prática possui uma carga horária de apenas 2 horas, 100% online e te introduzirá
              ao mundo do Marketing Ops!
            </Text>
          </FadeIn>
        </Flex>
      ...
      <Flex className={styles.section} bg="var(--mantine-color-gray-1)" align="center" direction="column">
        <Flex maw={650} mb={50} align="center" ta="center">
          <FadeIn transitionDuration={1000}>
          ...
          <Flex align="center" mb={25}>
            ...
            <Box ta="left" ml={50} maw={600}>
              ...
              <Text c="var(--mantine-color-dark-4)" fz="1.3rem" lh={1.4} fw={600} opacity={0.9}>
                ...
                Business Intelligence para Marketing e Vendas). Atua há <strong>10 anos com Marketing Ops</strong>, onde
                se especializou em análise de dados, mídias pagas e CRO, liderando equipes técnicas de mídias pagas e
                elaborando estratégias de aquisição para clientes de grande porte do <strong>Brasil</strong>,{" "}
          ...
          <Flex align="center">
            <Box ta="right" mr={50} maw={600}>
              ...
              <Text c="var(--mantine-color-dark-4)" fz="1.3rem" lh={1.4} fw={600} opacity={0.9}>
                ...
                <strong>8 anos com Marketing Ops e análise de dados</strong>, liderando as estratégias de mídias pagas,
                CRO, inbound marketing e <strong>growth hacking</strong> para empresas de diferentes segmentos
              </Text>
            </Box>
        ...
        <Box w={800}>
          <FadeIn transitionDuration={1000}>
            ...
            <Text c="white" fz="1.1rem" lh={1.4} fw={600} opacity={0.8} mb={25}>
              Tomar decisões baseadas em dados é o que diferencia as empresas que crescem exponencialmente daquelas que
              estagnam.
            </Text>
